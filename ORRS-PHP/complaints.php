                    ...
                    <form role="form"  data-toggle="validator" method="post" action="complaints.php">
                        <div class="row">
                            <div class="form-group col-lg-6">
                                <label>Name</label>
                                <input type="text" class="form-control" placeholder="Name" name="complainant_name" required>
                                <div class="help-block with-errors"></div>
                            </div>

                            <div class="form-group col-lg-6">
                                <label>Feedback Type</label>
                                <input type="text" class="form-control" placeholder="Feedback Type" name="complaint_type" required>
                                <div class="help-block with-errors"></div>
                            </div>

                            <div class="form-group col-lg-12">
                                <label>Giive your feedback</label>
                                <textarea class="form-control" name="complaint" placeholder="Feedback" required></textarea>
                            </div>
