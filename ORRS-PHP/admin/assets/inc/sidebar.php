              ...
              <div class="left-sidebar-content">
                <ul class="sidebar-elements">
                  ...
                  <li class="parent"><a href="#"><i class="icon mdi mdi-train"></i><span>Bus</span></a>
                    ...
                    <ul class="sub-menu">
                       <li><a href="emp-add-train.php">Add Bus</a>
                       <li><a href="emp-manage-train.php">Manage Bus</a>
                    </li>
                  ...
                  <li class="parent"><a href="#"><i class="icon mdi  mdi-square-inc-cash"></i><span>Accounting</span></a>
                    ...
                    <li class="parent"><a href="#"><i class="icon mdi  mdi-comment"></i><span>Feedback</span></a>
                    <ul class="sub-menu">
                      <li><a href="./view_complaint.php"><span class="badge badge-success float-right">View Feedback</span>View</a>
                      </li>
                    </ul>
                  </li>   
