        ...
        <div class="main-content container-fluid">
          <div class="splash-container">
            <div class="card card-border-color card-border-color-success">
              <div class="card-header"><img class="logo-img" src="assets/img/bus.png" alt="logo" width="{conf.logoWidth}" height="75"><span class="splash-description">Passenger Registration Form</span></div>
              <div class="card-body">
            ...
            <div class="splash-footer">&copy; 2019 - <?php echo date ('Y');?> Online VIP Transport booking system | Developed By Henry Iddrisu Maslan</div>
