<?php
    ...
    if(isset($_POST['Book_Train']))
    {
            ...
            */
            ...
            if($stmt)
            {
                $succ = "Reserved Bus Please Proceed To Check Out";
            }
            else 
            {
  ...
  <body>
    ...
    <!--Navigation Bar-->
      ...
      <div class="be-content">
        <div class="page-head">
          <h2 class="page-head-title">Book Bus </h2>
              ...
              <div class="card card-border-color card-border-color-success">
                ...
                <div class="card-body">
                  <form method ="POST">
                    ...
                    <div class="col-sm-6">
                        <p class="text-right">
                          <input class="btn btn-space btn-outline-success" value ="Book Bus" name = "Book_Train" type="submit">
