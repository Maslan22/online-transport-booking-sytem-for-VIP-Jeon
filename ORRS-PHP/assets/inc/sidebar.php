              ...
              <div class="left-sidebar-content">
                <ul class="sidebar-elements">
                  ...
                  <li class="parent"><a href="#"><i class="icon mdi mdi-face"></i><span><?php echo $row->pass_uname;?>'s Profile</span></a>
                    ...
                    <?php }?>
                  <li class="parent"><a href="#"><i class="icon mdi mdi-train"></i><span>Bus</span></a>
                  
                    <ul class="sub-menu">
                       <li><a href="pass-all-available-trains.php">All Available Bus</a>
                       <li><a href="pass-search-available-trains.php">Search Bus</a>
                    </li>
                      
                    </ul>
                
                  </li>
                  <li class="parent"><a href="#"><i class="icon mdi mdi-briefcase-edit-outline"></i><span>Book Bus</span></a>
                    <ul class="sub-menu">
                      <li><a href="pass-book-train.php">Reserve Bus</a>
                      </li>
                      <li><a href="pass-cancel-train.php">Cancel Bus</a>
                      </li>
                  ...
                  <li class="parent"><a href="#"><i class="icon mdi mdi-ticket-confirmation"></i><span>Tickets</span></a>
                    ...
                    <li class="parent"><a href="#"><i class="icon mdi mdi-ticket-confirmation"></i><span>Feedback</span></a>
                    <ul class="sub-menu">
                    <li><a href="complaints.php">Send Feedback</a>
                      </li>
